...
import pandas as pd
import logging
logging.basicConfig(level = logging.INFO, filename = 'model_logs.log', filemode = 'w', format = '%(asctime)s - %(levelname)s - %(message)s')
...
def predict():
    ...
    logging.info('information collected from web ui')
    ...
    logging.info('Prediction complete, returning the value!!')
